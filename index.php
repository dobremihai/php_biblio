...
<a href="input_clienti.php" target="I1">Iserare Clienti</a><br />
<a href="clienti.php" target="I1">Lista Clienti</a><br />
<a href="carte_edit.php" target="I1">Insert carte</a><br />

<form id="carti" name="carti" action="carti.php?page_no=0" target="I1" method="GET">
Liste carti:<br />
...
<iframe name="I1" frameborder="0" src="imprumuturi.php"></iframe>
